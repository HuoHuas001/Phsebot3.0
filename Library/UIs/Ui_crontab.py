...
class Ui_Crontab(object):
    def setupUi(self, Crontab):
        ...
        self.importer = QtWidgets.QPushButton(Crontab)
        self.importer.setGeometry(QtCore.QRect(280, 510, 81, 31))
        self.importer.setObjectName("importer")
        self.outer = QtWidgets.QPushButton(Crontab)
        self.outer.setGeometry(QtCore.QRect(190, 510, 81, 31))
        self.outer.setObjectName("outer")
        self.refrusher = QtWidgets.QPushButton(Crontab)
        self.refrusher.setGeometry(QtCore.QRect(370, 510, 81, 31))
        ...
        self.save.setGeometry(QtCore.QRect(460, 510, 81, 31))
    ...
    def retranslateUi(self, Crontab):
        ...
        self.importer.setText(_translate("Crontab", "导入"))
        self.outer.setText(_translate("Crontab", "导出"))
